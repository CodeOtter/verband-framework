...
class UploadedFile extends File
{
    ...
    public function __construct($path, $originalName, $mimeType = null, $size = null, $error = null, $test = false)
    {
        if (!ini_get('file_uploads')) {
            throw new \Exception(sprintf('Unable to create UploadedFile because "file_uploads" is disabled in your php.ini file (%s)', get_cfg_var('cfg_file_path')));
        }
    ...
    public function move($directory, $name = null)
    {
        ...
        throw new \Exception(sprintf('The file "%s" has not been uploaded via Http', $this->getPathname()));
    }
